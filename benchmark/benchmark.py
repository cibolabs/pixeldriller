...
Benchmark mode::
    ...
    > python3 -m profiles.benchmark --mode benchmark --repeat 1 \
        --read_from 0 --read_to 25

Profiling mode, to create the file pstac.profile with profiling information::

    > python3 -m profiles.benchmark --mode profile --pstats pstac.profile \
        --read_from 0 --read_to 25
...
def get_cmdargs():
    ...
    parser.add_argument(
        ...
        help=("The index of the first point in the --points_file file "
              "to read from."))
    parser.add_argument(
        "--read_to", default=None, type=int,
        help=("The index of the last point in the --points_file file "
              "to read up to."))
    parser.add_argument(
...
def create_points(json_file, read_from, read_to):
    ...
    for feature in feat_coll['features'][read_from:read_to]:
        ...
        coll_time = datetime.datetime(
            *gmtime[:6], tzinfo=datetime.timezone.utc)
